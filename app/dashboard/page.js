        ...
        <span className={styles.dashboard_page_container}>
            <span className={styles.Hamburger}>
                ...
                <span className={hamburgerOpen ? styles.Hamburger_Menu : styles.Hamburger_Menu_Closed}>
                    {userQuery?.data ? <span  onClick={() => setTab("user")} className={tab === "user" ? styles.purpleColor : styles.blackColor}><PowerSettingsNewIcon fontSize='inherit' /></span> : <Link href="/login"><PowerSettingsNewIcon fontSize='inherit' /></Link>}
